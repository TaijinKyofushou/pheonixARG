...
const segments: Segment[] = [
  ...
  { text: '> 首先确认一下身份——你不认识我，也没见过梁宇、■■■、张一然中的任何一个。你和我们之间没有任何因果牵连，连"擦肩而过"这种程度的都没有。对吧？', speed: 45, afterPause: 1400, names: true },
  { text: '> 放松啦，我没有在审你。我只是需要确认，你就是我要找的那个人。', speed: 35, afterPause: 1200 },
  { text: '环外人。', speed: 150, afterPause: 2000, special: 'outsider' },
  { text: '> ……这个词你大概已经在论文里看到了。“破局之机，惟环外也。”因果一旦连上，环里的人再怎么折腾都没用，代价只会在我们四个人之间不断累积，直到某一环彻底碎掉。', speed: 45, afterPause: 1300 },
  { text: '> 所以我得从环外找人。', speed: 60, afterPause: 900 },
  { text: '> 哪有那么简单。', speed: 30, afterPause: 1000 },
  { text: '> 就算找到一个和我们四个完全不相干的人，想完成“涅槃”仪式，也得从头到尾把因果梳理一遍。梳理的过程本身就已经算环内的人主动干预了——还是逃不出这个环。', speed: 45, afterPause: 1200 },
  { text: '> 所以我换了个思路。', speed: 55, afterPause: 1000 },
  { text: '> 既然活人找不到，那就找不活的。', speed: 160, afterPause: 1800 },
  { text: '> 开个玩笑啦。', speed: 25, afterPause: 700 },
  { text: '> 你现在看到的这些文字，这些聊天记录、论坛帖子、论文、录音——都是你自己主动找到的。信息传递的媒介也不是活人，是电脑。没有见面，没有交谈，当然也就没有因果。', speed: 50, afterPause: 1200 },
  ...
  { text: '> 其实我也不知道你能不能成功。我没法替你完成最后一步，只能告诉你该往哪里走，然后在这等着。等着看你是把业环解开，还是跟我一样，被这个东西吞掉。', speed: 45, afterPause: 1500 },
  ...
  { text: '> 如果成功了，业环会重置。张一然不用再躺在ICU里，梁宇不用再替我的愿望付代价。■■■——■■■大概会忘记2010年以后的一切。忘记我们。忘记我。', speed: 45, afterPause: 2000, names: true },
  { text: '> 也挺好的。', speed: 80, afterPause: 1800 },
  { text: '> 但你会记得。', speed: 60, afterPause: 2200 },
  { text: '> 你是环外人。是唯一一个从头到尾看清楚了一切的人。你会记得■■■曾经冲进火场的样子，记得张一然用血在黄纸上写字的样子，记得梁宇亲口许愿自己朋友消失的样子。也会记得我。', speed: 50, afterPause: 2000, names: true },
  { text: '> 想想还挺不公平的。', speed: 55, afterPause: 1200 },
