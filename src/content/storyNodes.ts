...
2025年12月31日晚19时30分许，我校计算机学院学生陈池（学号：2023768845）、梁宇（学号：2024582240）等三名同学，未经批准擅自闯入教学三号楼地下二层配电间及周边封闭区域。上述行为违反了《校园安全管理规定》第十二条及《学生违纪处分办法》第十七条，扰乱了正常校园秩序，且存在严重安全隐患。

事发后，经保卫处、学生工作处联合调查，上述三名同学均承认其违规行为。鉴于当事人认错态度良好，且未造成实际财产损失及人身伤害，根据《学生违纪处分条例》第二十一条，决定给予陈池、梁宇等三名同学通报批评处分。
...
经事后调查，起火原因为该单元302室（我校文学院张教授家庭住所）阳台线路老化短路引燃杂物。火灾发生时，张教授之子（我校附属小学学生张一然）正在卧室休息，因浓烟弥漫未能及时撤离，被困于室内。

在此次火灾中，我校附小学生王博傲发现火情后，不顾个人安危，两次冲入火场，成功将张教授之子从卧室救出并转移至安全地带。张一然因吸入过量浓烟及轻度烧伤，被送往市第三人民医院救治，后转入重症监护室，一度生命垂危；该名施救学生身体无碍，毫发未损。

此次火灾未造成其他人员伤亡。具体财产损失正在进一步统计中。

张教授家庭对施救学生的英勇行为深表感激。学校对该学生临危不惧、舍己救人的高尚品格予以充分肯定，授予其“三好学生”称号，并奖励奖金一千元。
...
Collide：你怎么知道的？
April：我和王博傲都许了愿，我们的因果衔接成环了。
Collide：你在说什么？
April：我去图书馆查了县志，查了关于凤凰、还愿、仪式的历史，结果还真的有记载。简单来说，我们都受到了愿望的反噬，那些愿望的代价因为形成了循环，会在我们身上不断叠加，直到其中一环消失。
April：你一定也许了关于王博傲的愿望，不然因果链无法闭环；而且这个愿望的代价一定非常沉重，所以你现在才会躺在这里。
April：我想来想去，也只有你们小时候的那场火灾了——你许愿让他活下来，代价是你自己的虚弱。我说的对吗？
Collide：……
Collide：你知道吗，王博傲跟我说他最近总能看到火场的幻觉，身上还有被灼烧的痛感。我许的那个愿望，它的效力正在不断流失，代价却在变本加厉地返还，再这样下去王博傲真的会死的！如果像你说的那样，是因为我们的愿望形成了环，那只要这个环断掉不就好了？反正我的身体也在不断衰竭，没人知道是怎么回事的。
Collide：——当然，只要你不要说出去。
Collide：你自己也在承受代价吧？你的失忆状况不是越来越严重了？只要我死了，一切都能解决。
April：你猜我为什么来这里？
April：我有其他方法，你放心好了。你和王博傲都会没事的。`,
    timeline: '2026年3月27日',
  },
  26: {
    id: 26,
...
> = {
  ...
  20: {
    ...
    content: `
      ...
      Bell：我昨天才看见
      锘垮舰绁炰勘鐏紝涓栦笉瀛樼剦锛：我在医院陪他，前几天陈池也来了
      Bell：A队也知道？就我不知道？
      ...
      锘垮舰绁炰勘鐏紝涓栦笉瀛樼剦锛：我问他他只说“陈池就是来看看”
      Bell：不对劲
      Bell：话说你那边能联系上陈池吗
      Bell：我好久都没见到他了
      Bell：电话也不接，发消息也不回
  ...
  25: {
    ...
    content: `
      Bell：找到了！关于那篇县志的记载！
      Bell：[[LINK:6]]
      锘垮舰绁炰勘鐏紝涓栦笉瀛樼剦锛：所以张一然和陈池都想牺牲自己，断掉这个循环是吧
...
Bell：能不能先报个平安TT`,
      ...
      },
      {
        ...
        content: `
          ...
          锘垮舰绁炰勘鐏紝涓栦笉瀛樼剦锛：是27号陈池来医院时和张一然的对话
